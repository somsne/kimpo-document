...
> ✅ **状态（2026-07-16）**：打印执行底座（P1 参数化 + P2 框式编排）已交付并真机验证，本目录教程即演示插件的可运行说明；契约权威 = 宿主仓 `docs/sheet/future/14-printing/kimpo-sheet-print-extension-plan-2026-07-15.md`（以其中 2026-07-15 实施拍板与真机修正为准）。
